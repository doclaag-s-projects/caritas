      ...
      <div class="main-content">
              ...
              <div v-for="(subcategory, subIndex) in category.subcategorias" :key="subIndex" class="sub-area">
                ...
                <ul v-if="subcategory.expanded">
                  <li v-for="file in subcategory.files" :key="file.id">
                    <a :href="file.ubicacion_archivo" class="text-blue-500 hover:underline">{{ file.nombre_archivo }}</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <main>
          ...
          <div class="document-grid">
            <div v-for="file in searchResult.flatMap(category => category.files)" :key="file.id" class="document-item">
              {{ file.nombre_archivo }}
            </div>
          </div>
        </main>
