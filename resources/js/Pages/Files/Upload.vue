...
<template>
    <AppLayout title="File-Upload">
            ...
            <div class="p-6 flex flex-col lg:flex-row">
              ...
              <div v-if="filePreviewUrl" class="w-full lg:w-1/2 lg:pr-6 mb-6 lg:mb-0">
                ...
                <div class="relative w-full h-0 pb-[100%] lg:pb-[75%]">
                  <iframe
                    ...
                    title="Previsualización del archivo PDF"
                  ></iframe>
                </div>
              </div>
              ...
              <div :class="['w-full', { 'lg:w-1/2 lg:pl-6': filePreviewUrl }]">
                <div class="space-y-6">
                  <!-- File Upload -->
                  <div class="upload">
                    <div v-if="selectedFile" class="flex items-center justify-between mb-4 p-4 bg-gray-100 border border-gray-200 rounded-md">
                      <div class="flex items-center">
                        <img src="/img/clip.svg" class="w-6 h-6 text-gray-600" alt="Archivo adjunto" />
                        <span class="ml-2 text-lg text-gray-700">{{ selectedFile.name }}</span>
                      </div>
                      <Switch
                        v-model="form.publico"
                        :label="form.publico ? 'Público' : 'Privado'"
                    ...
                    >
                      <div class="mr-2">
                        <img src="/img/file.svg" class="w-8 h-8 text-gray-500" alt="Icono de archivo" />
                      </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-2">
                      ...
                      >
                        <img src="/img/library-plus.svg" class="w-6 h-6 text-gray-600" alt="Agregar categoría" />
                      </button>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-2">
                      ...
                      >
                        <img src="/img/library-plus.svg" class="w-6 h-6 text-gray-600" alt="Agregar subcategoría" />
                      </button>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-2">
                      ...
                      >
                        <img src="/img/library-plus.svg" class="w-6 h-6 text-gray-600" alt="Agregar etiqueta" />
                      </button>
                    </div>
                  </div>
      ...
      <DialogModal :show="showFileModal" @close="showFileModal = false">
        ...
        <template #footer>
          <PrimaryButton
            @click="() => handleModalAction('rename')"
            class="mr-2 bg-indigo-600 hover:bg-indigo-700"
          >
            Renombrar
          </PrimaryButton>
          <PrimaryButton
            @click="() => handleModalAction('replace')"
      ...
      <CategoryModal
        ...
        @categoria-updated="handleCategoryUpdated"
      />
      ...
      <SubcategoryModal
        ...
        @update:show="showSubcategoryModal = $event"
